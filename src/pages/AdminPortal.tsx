...
export const AdminPortal: React.FC = () => {
  ...
  const bulkDefaults: Record<string, { price: number, desc: string }> = {
    'kashmiri jhumke': { price: 139, desc: 'Exquisite handcrafted Kashmiri Jhumke, designed with intricate details. Premium anti-tarnish finish for long-lasting shine.' },
    'korean earrings': { price: 69, desc: 'Elegant and trendy Korean style earrings. Lightweight, hypoallergenic, and perfect for everyday wear.' },
