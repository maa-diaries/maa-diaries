export interface Coupon { code: string; type: 'percent' | 'fixed'; value: number; minOrder: number; active: boolean; expiresAt?: string; }
const key = 'md_coupons_v1';
const defaults: Coupon[] = [{ code: 'AURA10', type: 'percent', value: 10, minOrder: 0, active: true }];
