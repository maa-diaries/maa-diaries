...
export const INITIAL_PRODUCTS: Product[] = [
  // --- EARRINGS (4) ---
  {
    ...
    subcategory: 'western',
    price: 899,
    image: '/src/assets/products/earrings_luxury.png',
    rating: 4.8,
    reviewsCount: 42,
  ...
  // --- NECKLACES (4) ---
  {
    ...
    category: 'necklaces',
    price: 1299,
    image: '/src/assets/products/necklace_emerald.png',
    rating: 4.7,
    reviewsCount: 19,
  ...
  // --- BRACELETS (4) ---
  {
    ...
    category: 'bracelets',
    price: 1399,
    image: '/src/assets/products/bracelet_gold.png',
    rating: 4.9,
    reviewsCount: 54,
    metalOptions: ['Anti-Tarnish Silver Plated', '18k Rolled Gold', 'Rose Gold Plated'],
  ...
  // --- HAIR ACCESSORIES (4) ---
  {
    ...
    price: 349,
    image: '/src/assets/products/ring_luxury_gold.png',
    rating: 4.9,
    reviewsCount: 68,
